...
const landingPages = [
  ...
  {
    id: "lp-21",
    domain: "bhartiairtelfoundation.org",
  ...
  {
    id: "lp-22",
    domain: "wise-oaks-landing-page.vercel.app",
    client: "Wise Oaks International School",
    project: "Admission Enquery",
    environment: "production",
  },
  {
    id: "lp-23",
  ...
  {
    id: "lp-25",
    domain: "admission.insd.edu.in/graphic-design-course",
    client: "INSD",
    project: "Marketing",
    environment: "production",
  },
  {
    id: "lp-26",
    domain: "admission.insd.edu.in/design-courses-delhi",
    client: "INSD",
    project: "Marketing",
    environment: "production",
  },
  {
    id: "lp-27",
    domain: "admission.insd.edu.in/design-courses-partners",
    client: "INSD",
    project: "Marketing",
    environment: "production",
  },
  {
    id: "lp-28",
    domain: "admission.insd.edu.in/interior-design-course",
    client: "INSD",
    project: "Marketing",
    environment: "production",
  },
  ...
  {
    id: "lp-30",
    domain: "queries.aluempire.com/aluminium-skirting-systems",
    client: "Alu Empire",
    project: "Skirting Systems",
    environment: "production",
  },
  {
    id: "lp-31",
    domain: "www.home2homefurniture.com/luxury-cafe-furniture",
    client: "Home2Home",
    project: "Luxury Cafe Furniture",
    environment: "production",
  },
  {
    id: "lp-32",
    domain: "queries.confur.net/billet-reheating-furnace",
    client: "Confur India",
    project: "Billet Reheating Furnace",
    environment: "production",
  },
  {
    id: "lp-33",
    domain: "queries.confur.net/aluminium-furnaces",
    client: "Confur India",
    project: "Aluminium Furnaces",
    environment: "production",
  },
  {
    id: "lp-34",
    domain: "github.com/Abhisharma08/Landing-Page-Downtime-Detector",
    client: "Confur India",
  ...
  {
    id: "lp-35",
    domain: "queries.advanintegrated.in/outdoor-advertising",
    client: "Ad Vantage",
  ...
  {
    id: "lp-36",
    domain: "queries.advanintegrated.in/brand-activation",
    client: "Ad Vantage",
  ...
  {
    id: "lp-37",
    domain: "queries.advanintegrated.in/retail-branding",
    client: "Ad Vantage",
  ...
  {
    id: "lp-38",
    domain: "queries.surpurabagh.com",
    client: "Surpura Bagh",
    project: "Main Website",
    environment: "production",
  },
  {
    id: "lp-39",
    domain: "ctetmocktest.edindia.org",
    client: "EdIndia",
    project: "Akrava Landing Page",
    environment: "production",
  },
  {
    id: "lp-40",
    domain: "admissions.dps.edu.sg",
    client: "DPS Singapore",
  ...
  {
    id: "lp-41",
    domain: "sbasss-chogawan.org",
    client: "Satya Bharti School",
    project: "Chogawan",
    environment: "production",
  },
  {
    id: "lp-42",
    domain: "sbasss-fattubhila.org",
    client: "Satya Bharti School",
    project: "Fattubhila",
    environment: "production",
  },
  ...
  {
    id: "lp-45",
    domain: "sbasss-sherpurkalan.org",
    client: "Satya Bharti School",
    project: "Sherpurkalan",
    environment: "production",
  }
];
...
const performCheck = async (page) => {
  try {
    ...
    const pageHistory = history.get(page.id) || [];
    const successfulChecks = pageHistory.filter(h => h.status === 'LIVE').length;
    const totalChecks = pageHistory.length;
    const uptime = totalChecks > 0 ? ((successfulChecks / totalChecks) * 100).toFixed(1) : 100;
    ...
    const stateUpdate = {
      ...
      lastChecked,
      risk: "High",
      uptime: history.get(page.id) && history.get(page.id).length > 0 
              ? ((history.get(page.id).filter(h => h.status === 'LIVE').length / history.get(page.id).length) * 100).toFixed(1) 
              : 0
    };
